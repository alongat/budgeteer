...
class YARD::Tags::RefTagList
  def initialize(tag_name, owner, name = nil); end
  def name; end
  def name=(arg0); end
  def owner; end
  def owner=(arg0); end
...
class YARD::Tags::DefaultTag < YARD::Tags::Tag
  def defaults; end
  def initialize(tag_name, text, types = nil, name = nil, defaults = nil); end
end
class YARD::CodeObjects::MacroObject < YARD::CodeObjects::Base
  def attached?; end
  def expand(call_params = nil, full_source = nil, block_source = nil); end
  def macro_data; end
  def macro_data=(arg0); end
  def method_object; end
  def method_object=(arg0); end
  def path; end
  def self.apply(docstring, call_params = nil, full_source = nil, block_source = nil, _method_object = nil); end
  def self.apply_macro(macro, docstring, call_params = nil, full_source = nil, block_source = nil); end
  def self.create(macro_name, data, method_object = nil); end
  def self.create_docstring(macro_name, data, method_object = nil); end
  def self.expand(macro_data, call_params = nil, full_source = nil, block_source = nil); end
  def self.find(macro_name); end
  def self.find_or_create(macro_name, data, method_object = nil); end
  def sep; end
end
